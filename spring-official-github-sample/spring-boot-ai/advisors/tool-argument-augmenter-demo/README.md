...
Demonstrates Spring
AI's [Tool Argument Augmentation](https://docs.spring.io/spring-ai/reference/api/tools.html#tool-argument-augmentation) —
a way to inject extra arguments into tool calls (e.g. LLM reasoning, confidence, memory notes) without modifying the
