...
Several Spring AI examples are web servers that expose HTTP endpoints rather than batch applications. The current
integration testing framework expects applications to:
