...
This document provides standardized `ExampleInfo.json` templates for different types of Spring AI examples. Use these
templates to ensure consistency and optimal configuration for new integration tests.
