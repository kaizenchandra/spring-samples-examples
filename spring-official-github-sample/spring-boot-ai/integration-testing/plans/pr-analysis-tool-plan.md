...
This document outlines the plan for creating a local command-line tool that maintainers can use when reviewing PRs to
automatically generate integration tests for new Spring AI example contributions.
...
Create a local command-line tool that maintainers run when reviewing PRs to automatically generate integration tests for
new example contributions. This tool will analyze the contributed code and generate all necessary integration test
files.
