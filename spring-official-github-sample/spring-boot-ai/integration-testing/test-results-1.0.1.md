...
**Root Cause**: The integration test runs from the module directory but the application expects the compose.yaml file at
a relative path that doesn't exist from the runtime location.
