...
This Spring Boot application demonstrates the implementation of tool callbacks using OpenAI's API and Spring AI. The app
simulates weather information retrieval for different cities using a mock weather service.
...
- Other Spring framework dependencies For the exact versions and complete list of dependencies, please refer to the
  pom.xml file in the project root.
