...
Demonstrates annotation-driven MCP development with Spring AI. Covers server-side tools, resources, prompts, and
completions, plus client-side notification handlers — all using declarative annotations.
