...
public class PromptProvider {
    ...
    public GetPromptResult personalizedMessage(McpSyncServerExchange exchange,
        ...
        exchange.loggingNotification(
                LoggingMessageNotification.builder(LoggingLevel.INFO, "personalized-message event").build());
        ...
        message.append("I'm here to assist you with any questions you might have about the Model Context Protocol.");
    ...
    public List<PromptMessage> conversationStarter(GetPromptRequest request) {
        return List.of(
                ...
                new PromptMessage(Role.ASSISTANT,
                        TextContent
                                .builder("Great choice! The Model Context Protocol (MCP) is a standardized way for servers "
    ...
    public List<String> stringListPrompt(@McpArg(name = "topic", description = "The topic to provide information about",
