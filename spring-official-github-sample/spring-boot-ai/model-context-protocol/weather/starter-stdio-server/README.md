...
A Spring Boot application demonstrating an MCP server with STDIO transport that exposes weather tools via
the [National Weather Service API](https://api.weather.gov). Uses the `spring-ai-starter-mcp-server` auto-configuration.
