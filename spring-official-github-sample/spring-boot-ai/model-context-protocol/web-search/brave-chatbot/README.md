...
Interactive chatbot combining Spring AI's Model Context Protocol (MCP) with
the [Brave Search MCP Server](https://github.com/modelcontextprotocol/servers/tree/main/src/brave-search). Maintains
conversation history via `MessageChatMemoryAdvisor` with an explicit conversation ID, and performs real-time web
searches through Brave Search.
...
An interactive chat session starts. Ask anything — the bot uses Brave Search for real-time web data and remembers prior
